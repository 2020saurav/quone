...
public class ScienceActivity extends ListActivity {
	
	JSONArray news = null;
	ArrayList<NewsInfo> objects = new ArrayList<NewsInfo>();
	tpDB newsinfo;
	ArrayList<NewsInfo> newsItems;
	ScienceArrayAdapter adapter;
	
	private static String response_url = "http://saurav.bl.ee/science.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		newsinfo.open();		
		newsItems=newsinfo.getScienceNews();
		newsinfo.close();
		adapter = new ScienceArrayAdapter(this, newsItems);
		...
		protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
            	...
            	try {
                    ...
                    newsinfo.open();
                    newsinfo.insertScienceNews(objects);
                    newsinfo.close();
            	}
