...
public class TechActivity extends ListActivity {
	
	JSONArray news = null;
	ArrayList<NewsInfo> objects = new ArrayList<NewsInfo>();
	tpDB newsinfo;
	ArrayList<NewsInfo> newsItems;
	TechArrayAdapter adapter;
	
	private static String response_url = "http://saurav.bl.ee/tech.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		newsinfo.open();		
		newsItems=newsinfo.getTechNews();
		newsinfo.close();
		adapter = new TechArrayAdapter(this, newsItems);
		...
		protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
            	...
            	try {
                    ...
                    newsinfo.open();
                    newsinfo.insertTechNews(objects);
                    newsinfo.close();
            	}
